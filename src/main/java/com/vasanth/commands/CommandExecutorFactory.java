...
public class CommandExecutorFactory {
    ...
    public CommandExecutorFactory(final ParkingLotService parkingLotService) {
        ...
        commands.put(
                RegNumbersWithColourCommandExecutor.COMMAND_NAME,
                new RegNumbersWithColourCommandExecutor(parkingLotService, outputPrinter));
        commands.put(
                SlotNumbersWithColourCommandExecutor.COMMAND_NAME,
                new SlotNumbersWithColourCommandExecutor(parkingLotService, outputPrinter));
        commands.put(
